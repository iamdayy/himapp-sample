    ...
    <UModal>
        <UCard>
            ...
            <div class="p-6 space-y-6">
                <div class="grid grid-cols-6 gap-6">
                    ...
                    <div class="col-span-6 sm:col-span-3">
                        ...
                        <UInput type="text" name="phone-number" id="phone-number" placeholder="e.g. +(12)3456 789"
                            v-model="colleger.phone" required />
                    </div>
                    <div class="col-span-6 sm:col-span-6">
                        ...
                        <div class="flex">
                            <UInput type="text" name="birth" id="birth" placeholder="Jakarta"
                                v-model="colleger.birth.place" required />
                    ...
                    <div class="col-span-3 sm:col-span-2">
                        ...
                        <UInput type="text" name="religion" id="religion" placeholder="Islam"
                            v-model="colleger.religion" required />
                    </div>
                    <div class="col-span-6 sm:col-span-2">
                        ...
                        <UInput type="text" name="citizen" id="citizen" placeholder="indonesia"
                            v-model="colleger.citizen" required />
                    </div>
                    <!--  -->
                    <!--  -->
                    <!-- Address Section -->
                    ...
                    <div class="col-span-6 sm:col-span-3">
                        ...
                        <UInput type="text" name="village" id="village" placeholder="Paesan"
                            v-model="colleger.address.village" required />
                    </div>
                    <div class="col-span-6 sm:col-span-3">
                        <label for="district"
                        ...
                        <UInput type="text" name="district" id="district" placeholder="Kedungwuni"
                            v-model="colleger.address.district" required />
                    </div>
                    <div class="col-span-6 sm:col-span-3">
                        <label for="city"
                            class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">City</label>
                        <UInput type="text" name="city" id="city" placeholder="Pekalongan"
                            v-model="colleger.address.city" required />
                    </div>
                    <div class="col-span-6 sm:col-span-3">
                        <label for="province"
                        ...
                        <UInput type="text" name="province" id="province" placeholder="Jawa Tengah"
                            v-model="colleger.address.province" required />
                    </div>
                    <div class="col-span-6 sm:col-span-3">
                        <label for="country"
                            class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Country</label>
                        <UInput type="text" name="country" id="country" placeholder="indonesia"
                            v-model="colleger.address.country" required />
                    </div>
                    <div class="col-span-6 sm:col-span-3">
                    ...
                    <div class="col-span-6 sm:col-span-3">
                        ...
                        <UInput type="number" name="NIM" id="NIM" placeholder="10220023" v-model="colleger.NIM"
                            required />
                    </div>
                ...
                <UButton type="submit" @click="addColleger" block :loading="loading">
                    Add New Colleger
                </UButton>
            </div>
        </UCard>
