...
const addNews = async () => {
    try {
        ...
        toast.add({ title: "Failed to add new Newss" });
    }
};
        ...
        <UCard :ui="{ background: 'bg-gray-200 dark:bg-gray-800' }">
            <template #header>
                <div class="flex justify-between w-full">
                    <h2 :class="['font-semibold dark:text-gray-200', responsiveClasses.title]">New News</h2>
            ...
            <div :class="['space-y-6 text-start', responsiveClasses.container]">
                <div :class="responsiveClasses.grid">
                    ...
                    <div :class="responsiveClasses.halfSpan">
                        ...
                        <UInput type="text" name="Title" id="Title" placeholder="News 1" :size="uiSize"
                ...
                <!-- Submit button -->
                <UButton @click.prevent="addNews" label="Save" icon="i-heroicons-clipboard" block trailing
