...
const register = async () => {
    try {
        ...
        toast.add({ title: "Success to register, welcome to himatika " + Form.value.username });
    } catch (error: any) {
            ...
            <div class="pb-8 mt-6 sm:mx-auto sm:w-full sm:max-w-sm max-h-96">
                <div class="space-y-2">
                    <div>
                        ...
                        <div class="mt-2">
                            <UInput id="NIM" name="NIM" type="number" color="gray" variant="outline" required
                                v-model="Form.NIM" />
                        </div>
                    </div>
                    <div>
                        ...
                        <div class="mt-2">
                            <UInput id="username-register" name="username" type="text" autocomplete="username" required
                                v-model="Form.username" color="gray" variant="outline" />
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <div class="mt-2">
                            <UInput id="password-register" name="password" type="password"
                                autocomplete="current-password" v-model="Form.password" required color="gray"
                                variant="outline" />
                        </div>
                    </div>
                    <div>
                        <label for="confirm-password"
                            ...
                            Password</label>
                        <div class="mt-2">
                            <UInput id="confirm-password" name="confirm-password" type="password"
